...
export interface BlackBurnReadOnlyInterface {
  contractAddress: string;
  supplyInfo: () => Promise<SupplyInfoResponse>;
  depositInfo: ({
    address
  }: {
    address: Addr;
...
export class BlackBurnQueryClient implements BlackBurnReadOnlyInterface {
  ...
  supplyInfo = async (): Promise<SupplyInfoResponse> => {
...
export interface BlackBurnInterface extends BlackBurnReadOnlyInterface {
  contractAddress: string;
  sender: string;
  receive: ({
    amount,
...
export class BlackBurnClient extends BlackBurnQueryClient implements BlackBurnInterface {
